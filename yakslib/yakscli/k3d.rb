...
module YaksCLI
  class K3d < SubCommandBase
    ...
    def create(cluster_name)
      require_relative '../labtools/_commands/k3d/create'
    ...
    def delete(cluster_name)
      require_relative '../labtools/_commands/k3d/delete'
    ...
    def start(cluster_name)
      require_relative '../labtools/_commands/k3d/start'
    ...
    def stop(cluster_name)
      require_relative '../labtools/_commands/k3d/stop'
